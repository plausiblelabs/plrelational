...
public class ModelDatabase {
    ...
    public func fetch<T: Model, Parent: Model>(type: T.Type, ownedBy: Parent) -> ModelToManyRelation<T> {
    ...
    public func fetch<T: Model, Child: Model>(type: T.Type, owning child: Child) -> ModelRelation<T> {
        let targetRelation = self.relationForModel(type)

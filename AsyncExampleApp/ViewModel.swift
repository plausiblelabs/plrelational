...
class ViewModel {
    ...
    private var selectedPerson: Relation
    ...
    init(undoManager: UndoManager) {
        ...
        selectedPerson = persons.join(selectedPersonID)
    ...
    lazy var string: ReadWriteProperty<String> = self.nameProperty(self.selectedPerson.project(["name"]))
}
